...
public class Baum implements IBaum {
	...
	public boolean isAuntOf(IPerson aunt, IPerson niece) {
		...
		if (nieceMother != null &&
			(auntNode.motherName == nieceMother.motherName ||
		...
		if (nieceFather != null &&
			(auntNode.motherName == nieceFather.motherName ||
	...
	private boolean checkIfParentsAreSiblings(Node node1, Node node2) {
		...
		if (node1Father.fatherName != null && node1Father.fatherName == node2Mother.fatherName) {
			return true;
		}

		Node node2Father = findNode(node2.fatherName);
		if (node2Father.fatherName != null && (node2Father.fatherName == node1Mother.fatherName
